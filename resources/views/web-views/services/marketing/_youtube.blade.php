...
@endsection
@section('description')
    If you are interested in promoting your company or product through YouTube, our experts will help you through the path with videography, photography, film making, shooting outside, promotional planning, boosting, strategic planning and ad making.
@endsection
...
@section('typeOfWork')
    ...
    <div class="process-work " data-sal="slide-left" data-sal-duration="1000" data-sal-delay="100">
        <div class="content">
            <h3 class="title"><span style="font-size:36px;color:#F5C05D;">Types of YouTube Marketing</span></h3>
            <p>
            ...
            <ul class="list-style angle">
                ...
                <li>Videography </li>
                <li>Film Making </li>
                <li>Shooting Outside </li>
            </ul>
        </div>
        <div class="thumbnail paralax-image">
            <img src="{{asset('frontend/assets/media/service/marketing/ytube.png')}}" alt="Thumbnail">
        </div>
    </div>
@endsection
