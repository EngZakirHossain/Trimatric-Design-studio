...
<section class="section section-padding-equal pt_md--80 pt_sm--60">
    <div class="container">
        <div class="section-heading heading-center">
            ...
            <h2 class="title">Some of our finest work.</h2>
        </div>
        <div class="axil-isotope-wrapper">
            ...
            @php
                $profiles = \App\Model\Profile::orderBy('id', 'desc')->take(9)->get();
            @endphp
            ...
            <div class="more-project-btn">
                <a href="{{route('portfolio')}}" class="axil-btn btn-fill-primary">View More</a>
            </div>
        </div>
    </div>
</section>
