    ...
    <div class="container">
        <div class="call-to-action">
            <div class="section-heading heading-light">
                ...
                <a href="#" class="axil-btn btn-large btn-fill-white">Estimate Your Project</a>
            </div>
            <div class="thumbnail">
{{--                <div class="larg-thumb" data-sal="zoom-in" data-sal-duration="600" data-sal-delay="100">--}}
{{--                    <img class="paralax-image" src="{{asset('frontend/assets/media/others/footer.png')}}" alt="Chat">--}}
{{--                </div>--}}
{{--                <ul class="list-unstyled small-thumb">--}}
{{--                    <li class="shape shape-1" data-sal="slide-right" data-sal-duration="800" data-sal-delay="400">--}}
{{--                        <img class="paralax-image" src="{{asset('frontend/assets/media/others/Group 1.png')}}" alt="Laptop">--}}
{{--                    </li>--}}
{{--                    <li class="shape shape-2" data-sal="slide-left" data-sal-duration="800" data-sal-delay="300">--}}
{{--                        <img class="paralax-image" src="{{asset('frontend/assets/media/others/Saly-16.png')}}" alt="Bill">--}}
{{--                    </li>--}}
{{--                </ul>--}}
            </div>
        </div>
